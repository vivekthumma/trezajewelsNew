                ...
                <div class="cart-content w-100">
                    ...
                    <div class="js-qty-wrapper cart-qty-wrap cart-drawer-qty mt-2 mt-sm-0">
                        <div class="js-qty-wrap d-flex align-items-center flex-nowrap extra-bg border-full rounded-pill overflow-hidden" style="display: inline-flex; width: max-content;">
                            <button type="button" class="qty-minus body-color bg-transparent border-0 px-2 py-1 d-flex align-items-center justify-content-center" data-id="{{ $item->id }}" aria-label="Remove item"><i class="ri-subtract-line d-block lh-1"></i></button>
                            ...
                            <button type="button" class="qty-plus body-color bg-transparent border-0 px-2 py-1 d-flex align-items-center justify-content-center" data-id="{{ $item->id }}" aria-label="Add item"><i class="ri-add-line d-block lh-1"></i></button>
                        </div>
                    </div>
                    </div>
                </div>
